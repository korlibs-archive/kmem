...
tasks.create("generate") {
    doLast {
        ...
        File("kmem/src/commonMain/kotlin/com/soywiz/kmem/KmemGen.kt").writeText(generateCommon().joinToString("\n"))
        File("kmem/src/jsMain/kotlin/com/soywiz/kmem/KmemGenJs.kt").writeText(generateJs().joinToString("\n"))
        File("kmem/src/jvmMain/kotlin/com/soywiz/kmem/KmemGenJvm.kt").writeText(generateJvm().joinToString("\n"))
    }
}
