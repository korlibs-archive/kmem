...
//infix fun Byte.xor(mask: Int): Int = this.toInt() xor mask
//infix fun Short.xor(mask: Int): Int = this.toInt() xor mask
//infix fun Short.xor(mask: Short): Int = this.toInt() xor mask.toInt()
