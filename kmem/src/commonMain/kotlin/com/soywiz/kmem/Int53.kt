...
inline class Int53(val value: Double) : Comparable<Int53> {
    ...
    inline operator fun plus(other: Number): Int53 = fromDoubleClamped(this.value + other.toDouble())
    inline operator fun plus(other: Int53): Int53 = this + other.double

    inline operator fun minus(other: Number): Int53 = fromDoubleClamped(this.value - other.toDouble())
    inline operator fun minus(other: Int53): Int53 = this - other.double

    inline operator fun times(other: Number): Int53 = fromDoubleClamped(this.value * other.toDouble())
    inline operator fun times(other: Int53): Int53 = this * other.value

    inline operator fun div(other: Number): Int53 = fromDoubleClamped(this.value / other.toDouble())
    inline operator fun div(other: Int53): Int53 = this / other.value

    inline operator fun rem(other: Number): Int53 = fromDoubleClamped(this.value % other.toDouble())
    inline operator fun rem(other: Int53): Int53 = this % other.value
    ...
    override fun compareTo(other: Int53): Int = this.value.compareTo(other.value)
    inline fun compareTo(other: Number): Int = this.value.compareTo(other.toDouble())
