...
actual inline fun MemBuffer._sliceInt8Buffer(byteOffset: Int, size: Int): Int8Buffer = Int8Array(this, byteOffset, size)
actual inline fun MemBuffer._sliceInt16Buffer(byteOffset: Int, size: Int): Int16Buffer = Int16Array(this, byteOffset, size)
actual inline fun MemBuffer._sliceInt32Buffer(byteOffset: Int, size: Int): Int32Buffer = Int32Array(this, byteOffset, size)
actual inline fun MemBuffer._sliceFloat32Buffer(byteOffset: Int, size: Int): Float32Buffer = Float32Array(this, byteOffset, size)
actual inline fun MemBuffer._sliceFloat64Buffer(byteOffset: Int, size: Int): Float64Buffer = Float64Array(this, byteOffset, size)
